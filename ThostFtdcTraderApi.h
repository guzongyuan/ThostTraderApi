...
#if !defined(_THOST_FTDCTRADERAPI_H_)
#define _THOST_FTDCTRADERAPI_H_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000

#include "KSOmsTradeAPI.h"

#if defined(WIN32)
#ifdef LIB_TRADER_API_EXPORTS
#define TRADER_API_EXPORTS __declspec(dllexport)
#else
#define TRADER_API_EXPORTS __declspec(dllimport)
#endif
#else
...
class TRADER_API_EXPORTS CThostFtdcTraderApi
{
public:
	///创建TraderApi
...
protected:
	CThostFtdcTraderApi()													{};
	~CThostFtdcTraderApi()													{};
	CThostFtdcTraderApi(const CThostFtdcTraderApi & other)					;
	CThostFtdcTraderApi & operator =(const CThostFtdcTraderApi &other)		;

private:
	static CKSThostFtdcTraderApi * m_ksApi;
};
